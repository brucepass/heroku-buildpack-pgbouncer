...
cat >> /app/pgbouncer_vendor/pgbouncer/pgbouncer.ini << EOFEOF
[pgbouncer]
listen_addr = 127.0.0.1
listen_port = 6000
auth_type = md5
auth_file = /app/pgbouncer_vendor/pgbouncer/users.txt
...
do
  ...
  cat >> /app/pgbouncer_vendor/pgbouncer/users.txt << EOFEOF
"$DB_USER" "$DB_MD5_PASS"
EOFEOF
...
chmod go-rwx /app/pgbouncer_vendor/pgbouncer/*
